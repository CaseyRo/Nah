...
- [x] 3.1 `cdi-1882-core-identity`
- [x] 3.2 `cdi-1883-your-circle`
- [x] 3.3 `cdi-1884-moments`
- [x] 3.4 `cdi-1885-reactions`
- [x] 3.5 `cap-05-messaging`, removed: Nah? has no chat
- [x] 3.6 `cap-06-ambient-presence`, removed: music moved into CDI-1884
- [x] 3.7 `cdi-1886-user-ownership`
- [x] 3.8 `cdi-1887-community-funding`
