...
Linear: [CDI-1882](https://linear.app/cdit/issue/CDI-1882)
...
- **Removed from the January version**:
  ...
  - reaction icons, which wait on CDI-1856 and belong to CDI-1885
...
- **Moved to other changes**:
  - onboarding and the full-circle message go to CDI-1883, where joining is connecting
  - moment card variants, the timeline clock, the offline queue and the media cache go to CDI-1884
...
- Not decided here: the logo itself. The bundle identifier stays `works.cdit.nah` (ruled 2026-09-15), and becomes permanent at the first store submission.
