...
- Choosing the donation platform, which is an open question.
...
### Pointing to the support page from the app

Apple and Google have rules about apps that point people to payments outside the store, and those rules differ between storefronts and have been changing. Whether the app mentions supporting Nah? at all is checked against the rules in force before it ships.
...
- Which donation platform.
- How often the finances are published.
- Where suggestions live without upvotes.
- Whether the app mentions supporting Nah? at all, given each store's rules.
