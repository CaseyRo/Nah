...
On 2026-09-23 Casey ruled that a person gives the name everyone recognises them by as the first step after joining, and that they are also asked their gender and their sexual orientation, each with "rather not tell". Those two are how people can show themselves to their circle, and later they can shape a person's page (CDI-1898, in the backlog).

## What Changes

- **who-you-are**:
  - a name, asked first after joining, which the person can change from their own page
  - gender and sexual orientation, asked in the first run once profiles are sealed, each with "rather not tell"
...
- **Elsewhere**:
  - CDI-1883's first run starts with the name, gains the two questions, and keeps its avatar photo in the same profile. An invite link, the page for a phone without Nah? and a refusal before connecting name nobody.
...
- `who-you-are`: a person's name, gender and orientation, and who can see them.
...
- `apps/mobile`: the name step, the two questions, the profile envelope, names on every moment, and editing the profile from your own page.
- Linear: CDI-1896 (the name, M1, blocks CDI-1835), CDI-1897 (gender and orientation, blocked by CDI-1863), CDI-1898 (personalisation, backlog).
